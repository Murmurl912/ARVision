...
public class AugmentedImageNode extends AnchorNode {
  ...
  private Node pikaNode;
  private CompletableFuture<ModelRenderable> pikaRenderable;

  public AugmentedImageNode(Context context) {
    pikaRenderable = ModelRenderable.builder()
  ...
  public void setImage(AugmentedImage image) {
    ...
    if(!pikaRenderable.isDone()) {
      CompletableFuture.allOf(pikaRenderable)
              .thenAccept((Void avoid)->setImage(image))
              .exceptionally(
                      throwable -> {
                        Log.d("Image", "exception loading ", throwable);
                        return null;
                      }
              );
      return;
    ...
    pikaNode = new Node();
    pikaNode.setParent(this);
    pikaNode.setRenderable(pikaRenderable.getNow(null));
    pikaNode.setLocalScale(new Vector3(0.1f, 0.1f, 0.1f));
    /*
